...
CTRL-C to exit wizard 

#Create a named gcloud project
gcloud projects create dedak8s --name="DEDA Kubernetes-Cloud"

#Set our current project context
gcloud config set project dedak8s
...
#   https://cloud.google.com/kubernetes-engine/docs/how-to/api-server-authentication#authenticating_users
#GCP zone https://cloud.google.com/compute/docs/regions-zones 
gcloud container clusters get-credentials cscluster --zone us-central1-a --project dedak8s
...
kubectl config use-context gke_dedak8s_us-central1-a_cscluster
...
#Delete our project.
gcloud projects delete dedak8s
