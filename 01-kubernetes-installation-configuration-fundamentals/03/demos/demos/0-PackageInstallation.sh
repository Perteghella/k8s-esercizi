#Setup 
#   1. 3 VMs  18.04.5 ( Ubuntu 16.04.5 old ), 1 master, 3 nodes.
2 Gb ram - 2 core 40 Gb HD - network privata, ip statico 172.16.94.x/24 dns 8.8.8.8
min 1 master e 1 node  
installazioni in inglese con tastiera ITA 
utente: cka 
password: password
installa SOLO OPENSSH server come servizio, nessun altro servizio 
