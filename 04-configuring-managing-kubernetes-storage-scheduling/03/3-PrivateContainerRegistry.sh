...
sudo docker tag bc5c421ecd6c perteghella/hello-app:ps


#Now push that locally tagged image into our private registry at docker hub
#You'll be using your own repository, so update that information here. 
sudo docker push perteghella/hello-app:ps
...
#you'll be using your own repository, so update that information here.
ssh cka@c1-node1 'sudo docker rmi perteghella/hello-app:ps'
ssh cka@c1-node2 'sudo docker rmi perteghella/hello-app:ps'
ssh cka@c1-node3 'sudo docker rmi perteghella/hello-app:ps'
...
sudo docker rmi perteghella/hello-app:ps
